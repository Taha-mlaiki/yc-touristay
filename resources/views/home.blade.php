            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg property-card">
                    <div class="overflow-hidden">
                        <img class="w-full h-56 object-cover property-img" src="https://themewagon.github.io/findstate/images/work-4.jpg"
                            alt="Luxury Villa">
                    </div>
                    <div class="p-6">
                        <span class="text-blue-600 font-semibold text-sm">FEATURED</span>
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Luxury Waterfront Villa</h3>
                        <p class="text-gray-600 mb-4">Beautiful modern villa with stunning ocean views and private
                            access to the beach.</p>
                        <div class="flex justify-between items-center mb-4">
                            <span class="text-2xl font-bold text-blue-600">$1,250,000</span>
                            <span class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded">For
                                Sale</span>
                        </div>
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg property-card">
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Downtown Loft Apartment</h3>
                        <p class="text-gray-600 mb-4">Stylish urban loft in the heart of downtown with high ceilings and
                            modern amenities.</p>
                        <div class="flex justify-between items-center mb-4">
                            <span class="text-2xl font-bold text-blue-600">$485,000</span>
                            <span class="bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded">For
                                Rent</span>
                        </div>
                        <div class="flex justify-between text-gray-500">
                            <div class="flex items-center">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg property-card">
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Suburban Family House</h3>
                        <p class="text-gray-600 mb-4">Spacious family home in a quiet neighborhood with a large backyard
                            and modern kitchen.</p>
                        <div class="flex justify-between items-center mb-4">
                            <span class="text-2xl font-bold text-blue-600">$675,000</span>
                            <span class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded">For
                                Sale</span>
                        </div>
                        <div class="flex justify-between text-gray-500">
