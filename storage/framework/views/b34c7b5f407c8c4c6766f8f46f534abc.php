...
<div id="modal" class="fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center p-4 z-50">
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl transform transition-all duration-300 scale-95 max-h-[90vh] overflow-y-auto">
        ...
        <!-- Modal Body -->
        <form id="announcementForm" class="p-6 space-y-6" method="POST" action="<?php echo e(route('announcements.create')); ?>" enctype="multipart/form-data">
            <!-- Title -->
            <?php echo csrf_field(); ?>
            <div>
...
</script><?php /**PATH C:\Users\hp\Desktop\TA\touristay\resources\views/components/announcement_modal.blade.php ENDPATH**/ ?>